...
\label{sec:org4ec74c7}
\begin{frame}[label={sec:org4f1b242},fragile]{Objetivo principal}
...
\begin{frame}[label={sec:org0666623},fragile]{Objetivos secundarios}
 \begin{columns}
...
\label{sec:org3fa9413}
\begin{frame}[label={sec:orge931c99}]{Soluciones actuales}
\begin{columns}
\begin{column}{0.2\columnwidth}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org25f9f81},fragile]{\texttt{solaR}}
 \begin{columns}
...
\label{sec:orgab3e9ef}
\begin{frame}[label={sec:org2d37e74}]{Procedimiento de cálculo}
\begin{center}
\includegraphics[scale=1]{../figuras/ProcedimientoCalculoRadiacionInclinada.pdf}
\end{center}
\end{frame}
\section{Desarrollo del código}
\label{sec:orgf82fbb8}
\begin{frame}[label={sec:orge995bfa}]{Algoritmo de cálculo}
\begin{center}
\includegraphics[height=0.9\textheight]{../figuras/procedure.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:org1dccc46},fragile]{\texttt{calcSol}}
 \begin{center}
\includegraphics[width=\textwidth]{../figuras/calcsol.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgda5d84b},fragile]{\texttt{Meteo}}
 \begin{center}
\includegraphics[width=\textwidth]{../figuras/meteo.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:org70b2b8f},fragile]{\texttt{calcG0}}
 \begin{center}
\includegraphics[width=\textwidth]{../figuras/calcg0.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:org2643723},fragile]{\texttt{calcGef}}
 \begin{center}
\includegraphics[width=\textwidth]{../figuras/calcgef.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgcf91f39},fragile]{\texttt{prodGCPV}}
 \begin{center}
\includegraphics[width=\textwidth]{../figuras/prodgcpv.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:org270ee61},fragile]{\texttt{prodPVPS}}
 \begin{center}
