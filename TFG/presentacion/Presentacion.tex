...
\label{sec:org8981f96}
\begin{frame}[label={sec:org1f3094f},fragile]{Objetivo principal}
...
\begin{frame}[label={sec:org6ef7b5e},fragile]{Objetivos secundarios}
 \begin{columns}
...
\label{sec:org6cd4c0f}
\begin{frame}[label={sec:org1c80a8b}]{Soluciones actuales}
\begin{columns}
\begin{column}{0.2\columnwidth}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:orgacce0ce},fragile]{\texttt{solaR}}
 \begin{columns}
...
\label{sec:orge0c2d28}
\begin{frame}[label={sec:org391de53}]{Procedimiento de cálculo}
\begin{center}
\includegraphics[scale=1]{../figuras/ProcedimientoCalculoRadiacionInclinada.pdf}
\end{center}
\end{frame}
\section{Desarrollo del código}
\label{sec:org65b7341}
\begin{frame}[label={sec:org75497ca}]{Algoritmo de cálculo}
\begin{center}
\includegraphics[height=0.9\textheight]{../figuras/procedure.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:org25bd9a3},fragile]{\texttt{calcSol}}
 \begin{center}
\includegraphics[width=\textwidth]{../figuras/calcsol.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:org0b7806d},fragile]{\texttt{Meteo}}
 \begin{center}
\includegraphics[width=\textwidth]{../figuras/meteo.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:org10e8415},fragile]{\texttt{calcG0}}
 \begin{center}
\includegraphics[width=\textwidth]{../figuras/calcg0.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgccc6f6e},fragile]{\texttt{calcGef}}
 \begin{center}
\includegraphics[width=\textwidth]{../figuras/calcgef.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:org4de7128},fragile]{\texttt{prodGCPV}}
 \begin{center}
\includegraphics[width=\textwidth]{../figuras/prodgcpv.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:org96d2315},fragile]{\texttt{prodPVPS}}
 \begin{center}
\includegraphics[width=\textwidth]{../figuras/prodpvps.pdf}
\end{center}
\end{frame}
\section{Ejemplo práctico de aplicación}
\label{sec:org9a9c8ac}
\begin{frame}[label={sec:orgc914e09},fragile]{Información meteorológica}
 \begin{lstlisting}[numbers=left,language=r,label= ,caption= ,captionpos=b]
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orga78b1c3},fragile]{Producción de diferentes sistemas}
 \begin{lstlisting}[numbers=left,language=r,label= ,caption= ,captionpos=b]
...
\begin{frame}[label={sec:org2444fe9}]{Comparación de producciones}
\begin{center}
...
\label{sec:org4c777aa}
\begin{frame}[label={sec:org71e17a9}]{Blame}
\begin{center}
\includegraphics[height=0.9\textheight]{../figuras/blame-fCompD.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:org1b0d35c}]{Blame}
\begin{center}
\includegraphics[width=\textwidth]{../figuras/blame-fCompD_cropped.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgc896481}]{Insights}
\begin{center}
\includegraphics[height=0.9\textheight]{../figuras/contributors.png}
\end{center}
\end{frame}
\section{Conclusiones}
\label{sec:org32f963d}
\subsection{Desarrollo a futuro}
\label{sec:org74d5d10}
\begin{frame}[label={sec:org6653d82},fragile]{Desarrollo a futuro}
 \begin{itemize}
