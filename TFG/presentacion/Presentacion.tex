...
\label{sec:org79635ee}
\begin{frame}[label={sec:orge9f4b97},fragile]{Objetivo principal}
...
\begin{frame}[label={sec:orgc61a6a7},fragile]{Objetivos secundarios}
 \begin{columns}
...
\label{sec:org5716ae7}
\begin{frame}[label={sec:orgc8e9fca}]{Soluciones actuales}
\begin{columns}
\begin{column}{0.2\columnwidth}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org2851444},fragile]{\texttt{solaR}}
 \begin{columns}
...
\label{sec:orgb3cb716}
\begin{frame}[label={sec:orgd3823e9}]{Procedimiento de cálculo}
\begin{center}
\includegraphics[scale=1]{../figuras/ProcedimientoCalculoRadiacionInclinada.pdf}
\end{center}
\end{frame}
\section{Desarrollo del código}
\label{sec:org1aba452}
\begin{frame}[label={sec:orgeeaecd2}]{Algoritmo de cálculo}
\begin{center}
\includegraphics[height=0.9\textheight]{../figuras/procedure.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgb1086e5},fragile]{\texttt{calcSol}}
 \begin{center}
\includegraphics[width=\textwidth]{../figuras/calcsol.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:org59faad3},fragile]{\texttt{Meteo}}
 \begin{center}
\includegraphics[width=\textwidth]{../figuras/meteo.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:org0af3df0},fragile]{\texttt{calcG0}}
 \begin{center}
\includegraphics[width=\textwidth]{../figuras/calcg0.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgc994464},fragile]{\texttt{calcGef}}
 \begin{center}
\includegraphics[width=\textwidth]{../figuras/calcgef.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:org60e90f0},fragile]{\texttt{prodGCPV}}
 \begin{center}
\includegraphics[width=\textwidth]{../figuras/prodgcpv.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:org09d2c7b},fragile]{\texttt{prodPVPS}}
 \begin{center}
