...
\label{sec:orgdabf869}
\begin{frame}[label={sec:org9716dfb},fragile]{Objetivo principal}
...
\begin{frame}[label={sec:orga2a37ac},fragile]{Objetivos secundarios}
 \begin{columns}
...
\label{sec:org3ebc3bf}
\begin{frame}[label={sec:orge56db9b}]{Soluciones actuales}
\begin{columns}
\begin{column}{0.2\columnwidth}
...
\end{columns}
\end{frame}
\begin{frame}[label={sec:org945f97b},fragile]{\texttt{solaR}}
 \begin{columns}
...
\label{sec:org710a6e4}
\begin{frame}[label={sec:org0c3d167}]{Procedimiento de cálculo}
\begin{center}
\includegraphics[scale=1]{../figuras/ProcedimientoCalculoRadiacionInclinada.pdf}
\end{center}
\end{frame}
\section{Desarrollo del código}
\label{sec:org96631c1}
\begin{frame}[label={sec:org2fce66a}]{Algoritmo de cálculo}
\begin{center}
\includegraphics[height=0.9\textheight]{../figuras/procedure.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:org7ce8ca8},fragile]{\texttt{calcSol}}
 \begin{center}
\includegraphics[width=\textwidth]{../figuras/calcsol.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:org5332574},fragile]{\texttt{Meteo}}
 \begin{center}
\includegraphics[width=\textwidth]{../figuras/meteo.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgef5f70d},fragile]{\texttt{calcG0}}
 \begin{center}
\includegraphics[width=\textwidth]{../figuras/calcg0.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgc303e3e},fragile]{\texttt{calcGef}}
 \begin{center}
\includegraphics[width=\textwidth]{../figuras/calcgef.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgf564803},fragile]{\texttt{prodGCPV}}
 \begin{center}
\includegraphics[width=\textwidth]{../figuras/prodgcpv.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:org32af7e2},fragile]{\texttt{prodPVPS}}
 \begin{center}
\includegraphics[width=\textwidth]{../figuras/prodpvps.pdf}
\end{center}
\end{frame}
\section{Ejemplo práctico de aplicación}
\label{sec:orgc2ca4f0}
\begin{frame}[label={sec:orgc7ebe5c},fragile]{Información meteorológica}
 \begin{lstlisting}[numbers=left,language=r,label= ,caption= ,captionpos=b]
...
\end{center}
\end{frame}
\begin{frame}[label={sec:orgd1ac4b3},fragile]{Producción de diferentes sistemas}
 \begin{lstlisting}[numbers=left,language=r,label= ,caption= ,captionpos=b]
...
\begin{frame}[label={sec:orgc03c941}]{Comparación de producciones}
\begin{center}
\includegraphics[height=0.9\textheight]{../figuras/ejemplos4.pdf}
\end{center}
\end{frame}
\section{Conclusiones}
\label{sec:orgdfb1f1a}
\subsection{Aportaciones}
\label{sec:org5d84ebe}
\begin{frame}[label={sec:org99f4e9c}]{Blame}
\begin{center}
\includegraphics[height=0.9\textheight]{../figuras/blame-fCompD.pdf}
\end{center}
\end{frame}
\begin{frame}[label={sec:org69cdf43}]{Blame}
\begin{center}
