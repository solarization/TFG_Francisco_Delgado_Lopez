...
- =readBD=: Esta familia de funciones puede leer ficheros de datos y transformarlos en un objeto de clase =Meteo=. Se dividen en:
  ...
  #+begin_src R :results graphics output :file "figuras/codigo-readBD.pdf" :width 8 :height 6
...
#+begin_src R :results graphics output :file "figuras/codigo-optimshdhoriz.pdf" :width 8 :height 6
...
#+end_src
#+ATTR_LATEX: :width \textwidth
file:figuras/codigo-optimshdhoriz.pdf
