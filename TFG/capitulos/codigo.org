...
#+end_src
#+ATTR_LATEX: :placement [!htb] :width 0.8\textwidth
#+CAPTION: Ábaco para planta de seguimiento a doble eje producto de la función =optimShd=, e interpretado graficamente por la función =shadeplot=.
...
#+end_src
#+ATTR_LATEX: :placement [!htb] :width 0.8\textwidth
#+CAPTION: Ábaco para planta fija producto de la función =optimShd=, e interpretado graficamente por la función =shadeplot=.
