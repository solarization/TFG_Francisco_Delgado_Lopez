...
Como se puede ver en la figura ref:fig:calcgef, =calcG0= funciona gracias a las siguientes funciones:
...
- =fInclin=: la cual, partiendo del resultado de =fTheta= y de un objeto de clase =G0=, cálcula la irradiancia solar incidente en una superficie inclinada junto con los efectos del ángulo de incidencia y la suciedad para obtener la irradiancia efectiva.
  ...
  - =iS=: permite seleccionar entre 4 valores del 1 al 4 correspondientes a la suciedad del módulo. Siendo 1 limpio y 4 alto y basandose en los valores de la tabla ref:tab:coef-perd computa la irradiancia efectiva.
  #+begin_src R
