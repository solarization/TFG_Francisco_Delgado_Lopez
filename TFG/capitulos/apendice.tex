...
\label{sec:org4a4a4f5}
\subsection{calcSol}
\label{sec:org4bce5fc}
...
\end{lstlisting}
\subsection{calcShd}
\label{sec:org2678257}
\label{subsec:calcShd}
\begin{lstlisting}[numbers=left,language=r,label= ,caption={calcShd},captionpos=b]
...
\end{lstlisting}
\subsection{optimShd}
\label{sec:org3703f12}
\label{subsec:optimShd}
\begin{lstlisting}[numbers=left,language=r,label= ,caption={optimShd},captionpos=b]
...
\section{Clases}
\label{sec:orgd7ca8d7}
\subsection{Sol}
\label{sec:org10f9430}
\label{subsec:sol}
...
\end{lstlisting}
\section{Funciones}
\label{sec:orgedd6db4}
\label{sec:funciones}
\subsection{corrFdKt}
\label{sec:org21418d3}
...
\end{lstlisting}
\begin{lstlisting}[numbers=left,language=r,label= ,caption={fSombra6},captionpos=b]
...
\end{lstlisting}
\subsection{solarAngles}
\label{sec:org67c8da4}
...
\end{lstlisting}
\section{Métodos}
\label{sec:orgc96bf54}
\label{sec:metodos}
\subsection{as.data.tableI}
\label{sec:orge769b0a}
...
\label{sec:orgd4e3123}
\label{sec:conjunto-datos}
\subsection{aguiar}
\label{sec:orgaeba1fa}
\label{subsec:aguiar}
