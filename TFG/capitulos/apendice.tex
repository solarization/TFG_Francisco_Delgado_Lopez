...
\label{sec:orgba5aed2}
\subsection{calcSol}
\label{sec:org8a53f7d}
...
\section{Clases}
\label{sec:orga832598}
\subsection{Sol}
\label{sec:orga74baaa}
\begin{lstlisting}[numbers=left,language=r,label= ,caption= ,captionpos=b]
setClass(
...
\end{lstlisting}
\section{Funciones}
\label{sec:org97b482f}
\subsection{corrFdKt}
\label{sec:orgf1bcda0}
\begin{lstlisting}[numbers=left,language=r,label= ,caption= ,captionpos=b]
#### monthly Kt ####
...
\end{lstlisting}
\section{Métodos}
\label{sec:org2a7e94a}
\subsection{as.data.tableI}
\label{sec:org9d8de4a}
\subsection{as.data.tableD}
\label{sec:org399e566}
\begin{lstlisting}[numbers=left,language=r,label= ,caption= ,captionpos=b]
...
\label{sec:org1adadee}
\subsection{aguiar}
\label{sec:org5318613}
\begin{lstlisting}[numbers=left,language=r,label= ,caption= ,captionpos=b]
data(MTM)
Ktlim
\end{lstlisting}
