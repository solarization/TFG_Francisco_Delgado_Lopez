...
En la figura \ref{fig:org2a3c151}, se muestra el proceso de cálculo que sigue el paquete a la hora de obtener la estimación de la producción del sistema fotovoltaico.
\begin{figure}[htbp]
\centering
\includegraphics[keepaspectratio,width=0.8\textwidth,height=0.43\textheight]{figuras/procedure.pdf}
\caption{\label{fig:org2a3c151}Proceso de cálculo de las funciones de \texttt{solaR2}}
\end{figure}
...
\begin{center}
\includegraphics[width=\textwidth]{figuras/codigo-finclinis.pdf}
\end{center}
\begin{itemize}
...
\begin{center}
\includegraphics[width=\textwidth]{figuras/codigo-finclinalb.pdf}
\end{center}
...
Max.   :2024-01-31 17:00:00.00   Max.   :1248.5   Max.   :1061.8   Max.   :1170.9366  
      D                  Di                 Dc               B                R          
Min.   :  0.4519   Min.   :  0.4519   Min.   :  0.00   Min.   :  0.00   Min.   :0.02496  
1st Qu.: 87.4382   1st Qu.: 38.5447   1st Qu.: 22.91   1st Qu.: 82.65   1st Qu.:1.42466  
Median :144.6206   Median : 52.3344   Median : 58.94   Median :230.00   Median :3.05507  
Mean   :140.3699   Mean   : 76.3276   Mean   : 64.04   Mean   :305.55   Mean   :3.20341  
3rd Qu.:187.2631   3rd Qu.:120.0449   3rd Qu.:102.29   3rd Qu.:496.65   3rd Qu.:4.66460  
Max.   :265.2378   Max.   :199.3722   Max.   :200.37   Max.   :922.89   Max.   :8.29293  
     FTb                FTd               FTr              Dief               Dcef       
Min.   :0.005218   Min.   :0.06474   Min.   :0.2995   Min.   :  0.4142   Min.   :  0.00  
1st Qu.:0.010325   1st Qu.:0.06474   1st Qu.:0.2995   1st Qu.: 35.3285   1st Qu.: 20.09  
...
\begin{center}
\includegraphics[width=\textwidth]{figuras/codigo-gef.pdf}
\end{center}
\section{Producción eléctrica de un SFCR}
\label{sec:orgd3501db}
...
\begin{center}
\includegraphics[width=\textwidth]{figuras/codigo-prodgcpv.pdf}
\end{center}

\section{Producción eléctrica de un SFB}
\label{sec:org6e63f9c}
...
\begin{center}
\includegraphics[width=\textwidth]{figuras/codigo-prodpvps.pdf}
\end{center}
\end{itemize}
\section{Optimización de distancias}
\label{sec:orgf386c39}
...
\begin{center}
\includegraphics[width=\textwidth]{figuras/codigo-optimshd2x.pdf}
\end{center}
\begin{lstlisting}[numbers=left,language=r,label= ,caption= ,captionpos=b]
...
\begin{center}
\includegraphics[width=\textwidth]{figuras/codigo-optimshdhoriz.pdf}
\end{center}
\begin{lstlisting}[numbers=left,language=r,label= ,caption= ,captionpos=b]
